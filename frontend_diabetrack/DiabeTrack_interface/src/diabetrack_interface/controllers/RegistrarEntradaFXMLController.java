...
// cliente HTTP compartido para envío peticiones al backend
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        // llamamos al método para cargar últimos 5 registros
        cargarUltimos5();
    ...
    // poblamos combobox con alimentos traídos de backend
    ...
    // procesamos respuesta y conversión 
...
// método para añadir alimento seleccionado
...
//método para guardar registro en bbdd
        ...
        httpClient.sendAsync(request, HttpResponse.BodyHandlers.ofString())
                .thenAccept(response -> {
                    if (response.statusCode() == 200 || response.statusCode() == 201) {
                        Platform.runLater(() -> {
                            showInfo("Registro guardado con éxito");
    ...
    // método para obtener de backend últimos 5 registros
    ...
    private double redondear05(double valor) {
        ...
        // método para mostrar alertas/errores/avisos
    ...
    // método para mostrar confirmación al registrar entrada
